...
function DataTable<T>(props: TableProps<T>): JSX.Element {
	...
	const handleRowClicked = React.useCallback((row: T, e: React.MouseEvent<Element, MouseEvent>) => onRowClicked(row, e), [onRowClicked]);

	const handleRowDoubleClicked = React.useCallback((row: T, e: React.MouseEvent<Element, MouseEvent>) => onRowDoubleClicked(row, e), [onRowDoubleClicked]);

	const handleRowMouseEnter = React.useCallback((row: T, e: React.MouseEvent<Element, MouseEvent>) => onRowMouseEnter(row, e), [onRowMouseEnter]);

	const handleRowMouseLeave = React.useCallback((row: T, e: React.MouseEvent<Element, MouseEvent>) => onRowMouseLeave(row, e), [onRowMouseLeave]);
